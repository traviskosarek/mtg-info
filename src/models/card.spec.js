...
describe("Card", function () {
    describe("createSet", function () {
        it("should return validated set", function () {
            ...
            var validateCardStub = sandbox.stub(card_1.Card, "validateCard");
            var returnedCard = card_1.Card.createCard(card);
            chai_1.expect(validateCardStub.called).to.be.true;
            chai_1.expect(returnedCard).to.deep.equal(card);
        ...
        it("should ignore additional values in validated set", function () {
            ...
            var returnedCard = card_1.Card.createCard(card);
            chai_1.expect(validateCardStub.called).to.be.true;
            chai_1.expect(returnedCard.extra_value1).to.be.undefined;
            chai_1.expect(returnedCard.extra_value2).to.be.undefined;
            chai_1.expect(returnedCard.extra_value3).to.be.undefined;
            validateCardStub.restore();
        });
        it("should throw errors", function () {
            ...
            var validateCardStub = sandbox.stub(card_1.Card, "validateCard").callsFake(function () {
                throw new Error("new validate card error");
            });
            var returnedCard;
            try {
                returnedCard = card_1.Card.createCard(card);
            }
            catch (e) {
                errorOccurred = true;
            }
            ...
            chai_1.expect(returnedCard).to.be.undefined;
            validateCardStub.restore();
        });
    });
